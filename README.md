...
following are few results I could achieve
...
```json
{
  ...
  "raw": "                                                                                                ' INCOME TAX DEPARTMENT                               i RAHUL GUPTA             SURESH GUPTA                               ‘ 23/1 1/j 974             Permanent Account Number                               ABCDE1234F                                                                 ‘ “I?“             SAMPLE - IMMIHELP.COM                               Signature ' - .. .\"             ‘ ‘_ ‘                               x, 8' “MA“                      "
}
```
...
```json
{
  ...
  "aadhaar_no": [
    {
      "value": "' J” 548550008000LLLLLLLLLLLLLLLLLLLLLLLILLLL",
      "words": [
        {
          "text": "'",
          "confidence": [
        ...
        {
          "text": "548550008000lllllllllllllllllllllllillll",
          "confidence": [
            78
          ]
        }
  ...
  "type": "AADHAAR",
  "raw": "                                                                                                 am [335             Tomlin Singh                               \"- 3* 3% War: 9mm:             : \";f‘ Father: ShcruSlngh             ‘1-- mW/Yearof Birth: 26-11-2009                               35?] Male                               ' j” 548550008000lllllllllllllllllllllllIllll                               m                      "
}
```
...
```json
{
  "name": [
    {
      "value": "NAME: MOHIT MUNJANI DALEZSLLO/ZOW",
      "words": [
        {
          "text": "name:",
          "confidence": [
  ...
  "pay": [
    ...
    {
      "value": "GROSS SALARY RS 2,500.00",
      "words": [
        {
          "text": "gross",
          "confidence": [
